        ...
        <div class="c-col-3">
            <div class="">
                <ul class="c-profile-list c-line c-profile-list-portfolio">
                    ...
                    <li class=" animation-element fade-up"><strong><div class="animation"><?= __('Kunde','ruffener');?></strong><br />
                        <?= get_field('rev_portfolio_customer'); ?></div>
                    </li>
                    <?php endif; ?>
                    <?php if( get_field('rev_portfolio_client') ): ?>
                    <li class=" animation-element fade-up"><strong><div class="animation"><?= __('Auftraggeber','ruffener');?></strong><br />
                        <?= get_field('rev_portfolio_client'); ?></div>
                    </li>
                    <?php endif; ?>
                    <?php if( get_field('rev_portfolio_services') ): ?>
                    <li class=" animation-element fade-up"><strong><div class="animation"><?= __('Leistungen','ruffener');?></strong><br />
                        <?php 
                    ...
                    <li class=" animation-element fade-up"><strong><div class="animation"><?= __('Releasedatum','ruffener');?></strong><br />
                ...
                <div  class=" animation-element fade-up">
                    <div class="animation"><a class="c-link-extern" target="_blank" href="<?= get_field('rev_portfolio_website'); ?>"><?= __('Zum Projekt','ruffener');?><span class="c-icon c-icon-extern"></span></a></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
