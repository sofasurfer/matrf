...
<div class="c-container c-pagenav">
    <div class="c-row c-row-align-center">
        <div class="c-col-4">
            <a class="c-icon c-link-back c-ir" href="<?= $backlink; ?>"><?= __('Zur Übersicht','ruffener');?></a>
        </div>
        <div class="c-col-8">
            <ul class="c-paging-list">
                <li><a class="c-icon c-link-back-small c-ir" href="<?= get_permalink($pdata['prev']->ID); ?>"><?= __('Zurück','ruffener');?></a></li>
                <li class="c-text-small"><?= $pdata['current'];?>/<?= $pdata['total'];?></li>
                <li><a class="c-icon c-link-next-small c-ir" href="<?= get_permalink($pdata['next']->ID); ?>"><?= __('Nächster','ruffener');?></a></li>
            </ul>
        </div>
    </div>
</div>